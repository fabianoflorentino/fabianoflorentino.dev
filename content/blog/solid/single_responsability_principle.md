+++
date = '2026-02-01T21:26:11-03:00'
draft = false
...
### 1️⃣ Regra de negócio: dados do sistema
...
### 2️⃣ Formatação: responsabilidade isolada
...
### 3️⃣ Handler HTTP: apenas transporte
...
### 4️⃣ Use case: orquestrando a regra de negócio
...
### 5️⃣ Handler HTTP: apenas transporte
...
### 6️⃣ Composição explícita no `main`
